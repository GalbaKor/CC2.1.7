...
export class Environment {
  constructor(scene) {
    ...
    this.material = new THREE.MeshPhongMaterial({
      ...
      vertexColors: THREE.VertexColors //ensure vertex colours is set so that we can use the randomisation
    });
...
export class Avatar {
  ...
  update(speed, obstacles, keyboard) {
    ...
    this.hero.rotation.x -= 0.28; //makes the mesh for the ball rotate to simulate a rolling movement
